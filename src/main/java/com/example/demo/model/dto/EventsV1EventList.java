...
public class EventsV1EventList implements KubernetesListObject {
  ...
  **/
  ...
  public EventsV1EventList items(List<EventsV1Event> items) {
  ...
  **/
  ...
  public void setItems(List<EventsV1Event> items) {
    this.items = items;
  }
