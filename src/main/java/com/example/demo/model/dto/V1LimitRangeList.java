...
import com.example.demo.model.dto.V1LimitRange;
...
public class V1LimitRangeList implements com.example.demo.model.dto.KubernetesListObject {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/")
