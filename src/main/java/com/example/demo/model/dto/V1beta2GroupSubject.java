...
public class V1beta2GroupSubject {
  ...
  public V1beta2GroupSubject name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1beta2GroupSubject v1beta2GroupSubject = (V1beta2GroupSubject) o;
    return Objects.equals(this.name, v1beta2GroupSubject.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta2GroupSubject {\n");
