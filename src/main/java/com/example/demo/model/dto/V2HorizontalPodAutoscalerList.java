...
import com.example.demo.model.dto.V2HorizontalPodAutoscaler;
...
public class V2HorizontalPodAutoscalerList implements com.example.demo.model.dto.KubernetesListObject {
  ...
  public V2HorizontalPodAutoscalerList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V2HorizontalPodAutoscalerList items(List<V2HorizontalPodAutoscaler> items) {
  ...
  **/
  ...
  public void setItems(List<V2HorizontalPodAutoscaler> items) {
    this.items = items;
  }


  public V2HorizontalPodAutoscalerList kind(String kind) {
  ...
  **/
  ...
  public V2HorizontalPodAutoscalerList metadata(V1ListMeta metadata) {
