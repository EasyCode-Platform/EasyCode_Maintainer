...
public class V1alpha1MatchCondition {
  ...
  public V1alpha1MatchCondition expression(String expression) {
  ...
  **/
  ...
  public V1alpha1MatchCondition name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1MatchCondition v1alpha1MatchCondition = (V1alpha1MatchCondition) o;
    return Objects.equals(this.expression, v1alpha1MatchCondition.expression) &&
        Objects.equals(this.name, v1alpha1MatchCondition.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1MatchCondition {\n");
