 ...
 */
@ApiModel(description = "ParamRef references a parameter resource")
...
public class V1alpha1ParamRef {
  ...
  **/
  ...
  @ApiModelProperty(value = "Name of the resource being referenced.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Namespace of the referenced resource. Should be empty for the cluster-scoped resources")
