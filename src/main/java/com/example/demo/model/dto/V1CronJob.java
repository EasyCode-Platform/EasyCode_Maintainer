...
import com.example.demo.model.dto.V1CronJobSpec;
import com.example.demo.model.dto.V1CronJobStatus;
...
public class V1CronJob implements com.example.demo.model.dto.KubernetesObject {
  ...
  public V1CronJob apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1CronJob kind(String kind) {
  ...
  **/
  ...
  public V1CronJob metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1CronJob spec(V1CronJobSpec spec) {
  ...
  **/
  ...
  public void setSpec(V1CronJobSpec spec) {
    this.spec = spec;
  }


  public V1CronJob status(V1CronJobStatus status) {
  ...
  **/
  ...
  public void setStatus(V1CronJobStatus status) {
    this.status = status;
  }
