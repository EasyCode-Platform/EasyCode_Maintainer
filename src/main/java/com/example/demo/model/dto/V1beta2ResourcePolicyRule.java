...
public class V1beta2ResourcePolicyRule {
  ...
  public V1beta2ResourcePolicyRule addApiGroupsItem(String apiGroupsItem) {
  ...
  **/
  ...
  public V1beta2ResourcePolicyRule addNamespacesItem(String namespacesItem) {
  ...
  **/
  ...
  public V1beta2ResourcePolicyRule addResourcesItem(String resourcesItem) {
  ...
  **/
  ...
  public V1beta2ResourcePolicyRule addVerbsItem(String verbsItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class V1beta2ResourcePolicyRule {\n");
