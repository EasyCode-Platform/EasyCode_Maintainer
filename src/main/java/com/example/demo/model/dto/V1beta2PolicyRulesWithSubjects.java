...
import com.example.demo.model.dto.V1beta2NonResourcePolicyRule;
import com.example.demo.model.dto.V1beta2ResourcePolicyRule;
import com.example.demo.model.dto.V1beta2Subject;
...
public class V1beta2PolicyRulesWithSubjects {
  ...
  private List<V1beta2NonResourcePolicyRule> nonResourceRules = null;

  public static final String SERIALIZED_NAME_RESOURCE_RULES = "resourceRules";
  @SerializedName(SERIALIZED_NAME_RESOURCE_RULES)
  private List<V1beta2ResourcePolicyRule> resourceRules = null;

  public static final String SERIALIZED_NAME_SUBJECTS = "subjects";
  @SerializedName(SERIALIZED_NAME_SUBJECTS)
  private List<V1beta2Subject> subjects = new ArrayList<>();
  ...
  **/
  ...
  public void setNonResourceRules(List<V1beta2NonResourcePolicyRule> nonResourceRules) {
    this.nonResourceRules = nonResourceRules;
  }


  public V1beta2PolicyRulesWithSubjects resourceRules(List<V1beta2ResourcePolicyRule> resourceRules) {
  ...
  **/
  ...
  public void setResourceRules(List<V1beta2ResourcePolicyRule> resourceRules) {
    this.resourceRules = resourceRules;
  }


  public V1beta2PolicyRulesWithSubjects subjects(List<V1beta2Subject> subjects) {
  ...
  **/
  ...
  public void setSubjects(List<V1beta2Subject> subjects) {
    this.subjects = subjects;
  }
  ...
  public boolean equals(Object o) {
    ...
    V1beta2PolicyRulesWithSubjects v1beta2PolicyRulesWithSubjects = (V1beta2PolicyRulesWithSubjects) o;
    return Objects.equals(this.nonResourceRules, v1beta2PolicyRulesWithSubjects.nonResourceRules) &&
        Objects.equals(this.resourceRules, v1beta2PolicyRulesWithSubjects.resourceRules) &&
        Objects.equals(this.subjects, v1beta2PolicyRulesWithSubjects.subjects);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta2PolicyRulesWithSubjects {\n");
